...
public class QnaController {
	...
	public String list(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum, String field, String keyword,
			Model mv, HttpSession session) {
	...
	@RequestMapping("/qna/qPopup")
	public String qPopup(HttpSession session, int qnum, Model mv) {
		String email = (String) session.getAttribute("login");
		AdminqnaVo vo2 = new AdminqnaVo(qnum, email, "", null, 0, 0, 0, 0, "", 0);
		AdminqnaVo vo = service.qnaStatus(vo2);
		System.out.println(vo.getAqtitle());
		System.out.println(vo.getAqcontent());
		mv.addAttribute("detailqna", vo);
		return "/qna/detailPopup2";
	}
	...
	public String admininsert(AdminqnaVo vo, Model mv) {
		...
		/*
		 * QnaVo vvo = service.qnagetinfo(vo.getQnum()); mv.addAttribute("admin", vvo);
	...
	// @ResponseBody
	// public String admininsert(@RequestParam("qnum")int qnum,
	// @RequestParam("title")String title, @RequestParam("content")String content,
	// @RequestParam("refer")int refer, @RequestParam("lev")int lev,
	// @RequestParam("step")int step, @RequestParam("p_num")int p_num) {
	//
	...
	//
	// QnaVo vo2 = new QnaVo(qnum, title, content, null, 0, refer, lev, step,
	// p_num);
