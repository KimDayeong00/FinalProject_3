...
public class BookListVo {
	...
	public BookListVo(int bk_num, String bk_startdate, String bk_enddate, String bk_situation, String m_email,
			String ps_email, String ps_name,int count, String pi_name) {
		super();
		this.bk_num = bk_num;
