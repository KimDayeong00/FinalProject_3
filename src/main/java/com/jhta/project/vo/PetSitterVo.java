...
public class PetSitterVo {
	...
	public PetSitterVo(String ps_email, String ps_pwd, String ps_phone, String ps_name, String ps_addr1,
			...
			String ps_saveimage, String ps_gubun, int careprice, int price) {
		super();
	...
	public String getPs_gubun() {
		return ps_gubun;
	}
	public void setPs_gubun(String ps_gubun) {
		this.ps_gubun = ps_gubun;
	}
	public int getCareprice() {
		return careprice;
	}
	public void setCareprice(int careprice) {
		this.careprice = careprice;
	}
	public int getPrice() {
		return price;
	...
	public String toString() {
		return "PetSitterVo [ps_email=" + ps_email + ", ps_pwd=" + ps_pwd + ", ps_phone=" + ps_phone + ", ps_name="
				...
				+ ps_originalimg + ", ps_saveimage=" + ps_saveimage + ", ps_gubun=" + ps_gubun + ", careprice="
				+ careprice + ", price=" + price + "]";
	}
