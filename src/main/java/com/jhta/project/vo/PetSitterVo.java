...
public class PetSitterVo {
	...
	public PetSitterVo(String ps_email, String ps_pwd, String ps_phone, String ps_name, String ps_addr1,
			...
			String ps_saveimage, int ps_gubun, int ps_active, int ps_grade) {
		super();
...
//	}
	...
	public int getPs_grade() {
		return ps_grade;
	}
	public void setPs_grade(int ps_grade) {
		this.ps_grade = ps_grade;
	}
	@Override
	public String toString() {
		return "PetSitterVo [ps_email=" + ps_email + ", ps_pwd=" + ps_pwd + ", ps_phone=" + ps_phone + ", ps_name="
				...
				+ ps_originalimg + ", ps_saveimage=" + ps_saveimage + ", ps_gubun=" + ps_gubun + ", ps_active="
				+ ps_active + ", ps_grade=" + ps_grade + "]";
	}
