                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email" id="regdate">답변날짜
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <fmt:formatDate value="${admindetail.aqregdate }" type="DATE" pattern="yyyy/MM/dd"/>
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email" id="title">답변제목
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email2" name="aqtitle" class="form-control col-md-7 col-xs-12" readonly="readonly" value = ${admindetail.aqtitle }>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="textarea" required="required" name="aqcontent" class="form-control col-md-7 col-xs-12" readonly="readonly">${admindetail.aqcomments }</textarea>
                        </div>
                      </div>
...
<div class="col-md-6 col-md-offset-3">
<br>
                          <button type="reset" class="btn btn-primary" onclick="outPopup()">닫기</button>
                        </div>
                        </div>
                      </div>
                  </div>
