...
<div
	...
	<table style="margin-top: 5px; padding: 10px;">
		...
		<tr style="padding: 10px;">
			...
			<td>
				<div class="calendar">
					<input type="text" id="selector" style="width: 200px"
						placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;날짜 선택하기">
				</div>
			</td>
		</tr>
			...
			<c:forEach var="vo" items="${filterlist }">
				<td style="text-align: center; margin: 0px;">
					<div class="btn-group" data-toggle="buttons" style="margin: 0px;">
						<label class="btn" style="width: 100%;"> <input
							type="checkbox" class="filterName" name="filterName"
							value="${vo.fl_name}"> ${vo.f_type }
						</label>
					</div>
				</td>
			</c:forEach>
...
<script type="text/javascript">
	...
	function initMap() {
		...
		list1(address);
		arraygetlist(37.566535, 126.97796919999996, 33.193668738614384,
				124.82258606250002, 38.53185554526987, 130.71125793750002)
				...
				.getJSON(
						...
						function(data) {
							...
							for (var q = 0; q < data.list.length; q++) {
								var petsitterList = "<div class='tour-block' style='padding:0; margin:0; border:1px solid black; margin-top:5px;'>"
								...
								for (var w = 0; w < data.list[q].list.length; w++) {
									petsitterList += "<div style='display: inline-block; margin:5px;'><span style='border:1px solid gray; color:gray; border-radius: 10px; padding: 5px;'>"
											+ data.list[q].list[w].f_type
											+ "</span></div>";
								}
								petsitterList += "</div>"
										+ "<div class='tour-details-text' style='margin:0px; padding:0px;'><span style='display: inline-block; color: gray; font-size: 20px; width:100%; margin:0px; padding:0px; margin-top:-5px; '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; day care/"
										+ data.list[q].ps_careprice
										+ "&nbsp;&nbsp;&nbsp;&nbsp; 1박/"
										+ data.list[q].ps_price
										+ "&nbsp;&nbsp;&nbsp;&nbsp; 대형견 추가금/"
										+ data.list[q].ps_overprice
										+ "</span></div>"
										+ "<div class='tour-details-btn' style='padding:5px;'> <span><a href='<c:url value='/detail?ps_email="
										+ data.list[q].ps_email
										+ "'/>' class='btn btn-primary'>예약하기</a></span> </div>"
										+ "</div>" + "</div>" + "</div>";
