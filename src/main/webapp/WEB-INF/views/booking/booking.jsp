		...
		<div class="bookingDetail">
			<form action="<c:url value='/reservation_p'/>" method="post" onsubmit="return checkIt();">
				<div class="bookingWrap">
					...
					<div class="priceWrap">
						<div class="priceBox">
							<span class="priceLeft">${ps_price } x ${ps_day }박</span><span class="priceRight"><strong>${price }원</strong></span>
						</div>
						<div class="priceBox">
						...
						<div class="priceBox">
							<span class="priceLeft">최종 금액</span><span class="priceRight"><strong>${allPrice }원</strong></span>
