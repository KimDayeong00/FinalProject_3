				...
				<section class="login_content">
					<form>
						...
						<div  class="login_wrapper" style="float: left;">
							<!-- 카톡 페이스북 네이버 로그인 -->
							<a id="kakao-login-btn" style="float: left; margin-left: 50px;"></a> <a
								href="http://developers.kakao.com/logout"></a> <br>
							<!-- 구글로그앤 -->
							<div id="my-signin2" style="float: left; margin-left: 50px;"></div>
							<br>
							<!-- 로그아웃하기 -->
							<!-- <a href="#" onclick="signOut();">Sign out</a> -->
							<br>
							<div id="naver_id_login" style="width: 200px;" title="보수중"> </div>
						</div>
						...
						<div class="separator">
							<p class="change_link">
								가입하고 싶으세요? <a href="<c:url value="/register" />"> 계정 만들기 </a>
							</p>
...
<script type="text/javascript">
	var naver_id_login = new naver_id_login("MfMVXKoyjlrxFxb21n3w",
			"http://localhost:8090/project/member/navercallback.jsp");
